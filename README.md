...
| Domains                  | Technologies and Tools           |
|--------------------------|----------------------------------|
| **Pentesting**            | Kali Linux, Parrot OS, Metasploit, Burp Suite |
| **OSINT**                 | Maltego, SpiderFoot, Sherlock    |
| **Reverse Engineering**   | Ghidra, IDA Pro, Radare2         |
| **Malware Development**   | Rust, Assembly, C, Python        |
| **Vulnerability Exploitation** | HackTheBox, TryHackMe, RootMe |
| **Development**           | Java, Rust, C, Python            |
